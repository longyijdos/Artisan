...
export function FolderIcon({ isOpen, className = "w-4 h-4" }: { isOpen?: boolean; className?: string }) {
  if (isOpen) {
    return (
...
// Icon for new folder
export function NewFolderIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
